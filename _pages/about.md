...
- [CD-VLN: Boosting Language-Goal Aerial Navigation with Open-Source LLMs via Cognitive Perception and Dual-System Decision-making](https://example.com/paper1), __Xiangyu Dong__, Xiaoguang Ma <sup>†</sup>, Submitted to CVPR 2026.
- [MMR-VLN: Towards Continual Vision-and-Language Navigation via Multimodal Memory and Retrieval](https://example.com/paper1), Haozhou Li *, __Xiangyu Dong *__, Xiaoguang Ma <sup>†</sup>, Submitted to ICRA 2026.
